...
constexpr const char kSeedManifestHash[] = "d38ecb66f177858e0bdf7f979d8bc1d4470bd03a3d5089ac5fa7dd55e99d0843";

constexpr SeededBook kSeededBooks[] = {
  { "/books/books/european-letter-demo.rsvp", R"SEEDBOOKS(@rsvp 1
...
Æ æ Œ œ Ø ø Å å Ä ä Ö ö Ü ü Þ þ Ð ð Ł ł Č č Š š Ž ž Ă ă Ș ș Ț ț Ğ ğ Ş ş İ ı Ą ą Ę ę Ć ć Ń ń Ś ś Ź ź Ż ż Ā ā Ē ē Ģ ģ Ī ī Ķ ķ Ļ ļ Ņ ņ Ė ė Į į Ų ų Ū ū Đ đ Ŋ ŋ Ŧ ŧ.
  ...
  { "/books/books/getting-started.rsvp", R"SEEDBOOKS(@rsvp 1
...
constexpr std::size_t kSeedBookCount = sizeof(kSeededBooks) / sizeof(kSeededBooks[0]);
